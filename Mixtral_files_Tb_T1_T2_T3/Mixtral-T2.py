...
tags = np.load('path of word tag file', allow_pickle=True).item()
...
def word_tag(i):
    ...
    for key, values in tags[i].items():
        #print(key, values)
        string += f'{key}'
        string += ': '
...
for _, row in data.iterrows():
    ...
    Leverage the understanding from morphological tags and english meanings of the word splits to enhance/modify translation. Use the word splits and morphological tags to understand the case, gender or the tense of verbs, etc. 
